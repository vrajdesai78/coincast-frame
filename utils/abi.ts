export const NFTABI = [
  ...
  {
    inputs: [],
    name: "getAddressOfCourseContract",
    outputs: [
      {
        internalType: "address",
        name: "",
...
export function extractStringFromUrl(url: string): string | null {
  const startIndex = url.indexOf("https://") + "https://".length;
  const endIndex = url.indexOf(".ipfs.nftstorage.link");
